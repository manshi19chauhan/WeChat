...
import { LoaderIcon, MapPinIcon, Video, ShuffleIcon } from "lucide-react";
...
const OnboardingPage = () => {
  ...
  /* handle random avatar */
   const handleRandomAvatar = () => {
    ...
    setFormState({ ...formState, profilePhoto: randomAvatar });
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="form-control">
              ...
              <input
                ...
                onChange={(e) => setFormState({ ...formState, fullname: e.target.value })} // "..." is(spread operator) used to spread the existing state if no use then overwrites the entire data
